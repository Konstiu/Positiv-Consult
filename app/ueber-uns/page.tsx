    ...
    return (
        <>
            ...
            <section className="mx-auto w-full max-w-5xl px-5 pb-18 md:px-8 md:pb-24">
                ...
                {/* MOBILE: vertical list with connecting line + dots */}
                <div className="mt-12 md:hidden">
                    <div className="relative ml-[11px] space-y-6 border-l-2 border-[var(--brand-blue)]/30 pl-8">
                        {companyStory.map((item) => (
                            <div key={`${item.year}-${item.title}`} className="relative">
                                {/* Dot, positioned on the line */}
                                <div
                                    className="absolute -left-[44px] top-1 flex h-6 w-6 items-center justify-center rounded-full bg-[var(--brand-blue)] ring-4 ring-white">
                                    <div className="h-1.5 w-1.5 rounded-full bg-white"/>
                                </div>
                                {/* Card */}
                                <div className="rounded-2xl border border-black/5 bg-white/60 px-4 py-4">
                    ...
                    <div className="space-y-8">
                        {companyStory.map((item, index) => (
                            ...
                            >
                                ...
                                <div
                                    className="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-[var(--brand-blue)] ring-4 ring-white">
