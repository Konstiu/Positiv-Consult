...
export default function AIConsultingPage() {
    return (
        <>
            ...
            <section
                className="mx-auto grid w-full max-w-7xl gap-5 px-5 py-18 md:px-8 lg:grid-cols-2 xl:grid-cols-3 md:py-24">
            ...
            <section className="mx-auto grid w-full max-w-7xl gap-5 px-5 py-4 md:px-8 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                <article className="surface-card p-6 md:p-8">
                    ...
                    <p className="mt-5 text-base leading-8 text-[var(--muted)]">
                        KI-Beratung bei POSITIVconsult bedeutet nicht, jedem Trend nachzulaufen. Relevant sind nur jene
                        Themen, die im Unternehmen tatsächlich Zeit sparen, Qualität erhöhen, Entscheidungen verbessern
                        oder operative Reibung reduzieren. Genau dort setzen wir an.
                    </p>
