  ...
  return (
    <>
      <PageHeader
        ...
        description="POSITIVconsult unterstützt Unternehmen dabei, KI sinnvoll zu bewerten, konkrete Anwendungsfelder zu priorisieren und die Umsetzung wirtschaftlich und organisatorisch tragfähig aufzusetzen."
        highlights={[
