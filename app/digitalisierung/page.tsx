                ...
                <div className="mx-auto max-w-3xl space-y-10 text-center">
                    ...
                    <div className="text-left">
                        ...
                        <p className="mt-4 text-base leading-8 text-[var(--muted)]">
                            Digitalisierung beginnt selten auf der grünen Wiese. Meist geht es um bestehende Prozesse,
                            gewachsene Systeme, operative Engpässe und eine Vielzahl von Ideen. Wir helfen dabei, daraus
                            eine sinnvolle Reihenfolge zu machen und echte Hebel von Nebenschauplätzen zu trennen.
                        </p>
                    </div>
                </div>
            </section>
